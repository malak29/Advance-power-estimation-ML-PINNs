    ...
    if (ANN_Type == 1): # MLP
        ...
        if (NeuralStateSpace_ModelType == 1):  # Not Nueral State Space
            ...
            Current_ANNModel_A = tf.keras.Sequential([
                ...
                # layers.Dense(30, activation='relu'),
                # layers.Dense(30, activation='relu', kernel_regularizer='l2'),
                layers.SimpleRNN(7*Lag_Number, input_shape=(Lag_Number,1), return_sequences=False),
                #layers.Dense(7, activation='relu', kernel_regularizer='l2'),
                layers.Dense(units=1, activation='linear')
            ])
            ...
            Current_ANNModel_B = tf.keras.Sequential([
                ...
                # layers.Dense(30, activation='relu'),
                # layers.Dense(30, activation='relu', kernel_regularizer='l2'),
                layers.SimpleRNN(7*Lag_Number, input_shape=(Lag_Number,Train_X_TF.shape[1]-1), return_sequences=False),
                #layers.Dense(7, activation='relu', kernel_regularizer='l2'),
                layers.Dense(units=1, activation='linear')
            ])
        ...
        if (NeuralStateSpace_ModelType == 1):  # Not Nueral State Space
            ...
            Current_ANNModel_A = tf.keras.Sequential([
                ...
                # layers.Dense(30, activation='relu'),
                # layers.Dense(30, activation='relu', kernel_regularizer='l2'),
                layers.LSTM(7*Lag_Number, input_shape=(Lag_Number,1), return_sequences=False),
                layers.Dense(units=1, activation='linear')
            ])
            ...
            Current_ANNModel_B = tf.keras.Sequential([
                ...
                # layers.Dense(30, activation='relu'),
                # layers.Dense(30, activation='relu', kernel_regularizer='l2'),
                layers.LSTM(7*Lag_Number, input_shape=(Lag_Number,Train_X_TF.shape[1]-1), return_sequences=False),
                layers.Dense(units=1, activation='linear')
            ])
        ...
        if (NeuralStateSpace_ModelType == 1):  # Not Nueral State Space
            ...
            Current_ANNModel_A = tf.keras.Sequential([
                ...
                # layers.GRU(21, input_shape=(1,Train_X_TF.shape[1]), return_sequences=True, kernel_regularizer='l2'),
                # layers.GRU(14, input_shape=(1,Train_X_TF.shape[1]), return_sequences=True, kernel_regularizer='l2'),
                layers.GRU(7*Lag_Number, input_shape=(Lag_Number,1), return_sequences=False),
                layers.Dense(units=1, activation='linear')
            ])
            ...
            Current_ANNModel_B = tf.keras.Sequential([
                ...
                # layers.GRU(21, input_shape=(1,Train_X_TF.shape[1]), return_sequences=True, kernel_regularizer='l2'),
                # layers.GRU(14, input_shape=(1,Train_X_TF.shape[1]), return_sequences=True, kernel_regularizer='l2'),
                layers.GRU(7*Lag_Number, input_shape=(Lag_Number,Train_X_TF.shape[1]-1), return_sequences=False),
                layers.Dense(units=1, activation='linear')
            ])
