...
ANN_PercentageAccuracy_DF = copy.deepcopy(pd.DataFrame(columns=['ANN Model Name', 'Training Mean Error', 'Testing Mean Error Without Simulation', 'Testing Mean Error With Simulation', 'Final Train Error', 'Final Train Loss', 'Final Val Error', 'Final Val Loss', 'Time/Iteration']))
