...
def commercial_climate_zone(commercial_building_location):
    ...
    if (commercial_building_location == 'HoChiMinh'):
        ...
        climate_zone = '2A'
    elif (commercial_building_location == 'Tuscon'):  
        climate_zone = '2B'
...
for file_name in os.listdir(commercial_models_folderpath):
    
    file_path = os.path.join(commercial_models_folderpath, file_name)
    model_information = parse_name_commercial(file_name)
