...
Aggregation_Zone_List = [['CORE_ZN'],['PERIMETER_ZN_1'],['PERIMETER_ZN_2'],['PERIMETER_ZN_3'],['PERIMETER_ZN_4']] # DOE Small Office: CORE_ZN , PERIMETER_ZN_1 , PERIMETER_ZN_2, PERIMETER_ZN_3 , PERIMETER_ZN_4

# 1Zone - [['CORE_ZN','PERIMETER_ZN_1','PERIMETER_ZN_2','PERIMETER_ZN_3','PERIMETER_ZN_4']]
# 2Zone - [['CORE_ZN'],['PERIMETER_ZN_1','PERIMETER_ZN_2','PERIMETER_ZN_3','PERIMETER_ZN_4']]
# 3Zone - [['CORE_ZN'],['PERIMETER_ZN_1','PERIMETER_ZN_2'],['PERIMETER_ZN_3','PERIMETER_ZN_4']]
# 5Zone - [['CORE_ZN'],['PERIMETER_ZN_1'],['PERIMETER_ZN_2'],['PERIMETER_ZN_3'],['PERIMETER_ZN_4']]
...
pickle.dump(Aggregation_Dict, open(os.path.join(Sim_AggregatedData_FolderPath,Aggregation_File_Name), "wb"))
