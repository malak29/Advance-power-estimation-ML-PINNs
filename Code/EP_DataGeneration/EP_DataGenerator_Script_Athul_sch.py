...
People_Schedule_Name_1 = 'bldg_light_sch'

People_Schedule_Dict_1 = {
                          'field_1': 'Through: 12/31',
                          'field_2': 'For: Weekdays',
                          'field_3': 'Until: 5:00,0.18',
                          'field_4': 'Until: 6:00,0.23',
                          'field_5': 'Until: 7:00,0.178641345',
                          'field_6': 'Until: 8:00,0.32621463',
                          'field_7': 'Until: 12:00,0.69903135',
                          'field_8': 'Until: 13:00,0.6213612',
                          'field_9': 'Until: 17:00,0.69903135',
                          'field_10': 'Until: 18:00,0.473787915',
                          'field_11': 'Until: 20:00,0.32621463',
                          'field_12': 'Until: 22:00,0.24854448',
                          'field_13': 'Until: 23:00,0.178641345',
                          'field_14': 'Until: 24:00,0.18',
                          'field_15': 'For: Weekends',
                          'field_16': 'Until: 24:00,0.18',
                          'field_17': 'For: Holiday',
                          'field_18': 'Until: 24:00,0.18,',
                          'field_19': 'For: WinterDesignDay',
                          'field_20': 'Until: 24:00,0',
                          'field_21': 'For: SummerDesignDay',
                          'field_22': 'Until: 24:00,1',
                          'field_23': 'For: CustomDay1',
                          'field_24': 'Until: 24:00,0',
                          'field_25': 'For: CustomDay2',
                          'field_26': 'Until: 24:00,0',
                          }

Sim_People_Schedules_Dict ={People_Schedule_Name_1: People_Schedule_Dict_1}
...
Schedule_Dict_List = [Sim_People_Schedules_Dict]
...
if (IDF_Type == "ASHRAE"):
    ...
    IDF_FilePath = os.path.join(Current_FilePath,  '..',  '..', 'Data', 'IECC', Year_FolderName, IDF_FileName)   
...
for iii in dir(Current_ScheduleCompact):
...
# for iii in dir(Current_ScheduleCompact_Records_Dict):
...
new_sch = Current_ScheduleCompact.add(
...
Special_IDFFile_Path = os.path.join(Edited_IDFFile_FolderPath, "Special.idf")
