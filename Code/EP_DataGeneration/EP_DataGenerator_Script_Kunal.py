...
AllData_Indicator = True  # True - All variables generated based on .rdd file ; False - Prescribed variables are generated
...
for files in os.listdir(Temporary_FolderPath):
 ...
 # =============================================================================
# Deleting all CSV Files from Sim_ProcessedData Folder
# =============================================================================         