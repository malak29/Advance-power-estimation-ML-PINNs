...
#This version has csv generation code commented out for faster runs
#Created to solve officelarge error when processing eio
#Used to solve DateTime_Split index error
...
- Tucson
'''
IDF_Location = "Atlanta"

# Simulation Name
Simulation_Name = "ASHRAE_2013_Seattle_OfficeLarge"
