...
#Script2 but with CSV code uncommented, version being used for un-automated generations.
...
- Tucson
'''
IDF_Location = "Albuquerque"

# Simulation Name
Simulation_Name = "ASHRAE_2013_Albuquerque_OfficeLarge"
...
#This line is for when CSV code is commented out
...
#This version of the script only runs the simulation once, gets the eplusout file. 